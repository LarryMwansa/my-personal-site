        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.companyInfo}>
            ...
            <div className={styles.socialLinks}>
              <a
                href="https://github.com/LarryMwansa/bwanji_base"
                target="_blank"
              ...
              <a
                href="https://web.facebook.com/bwanjidigital"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.socialLink}
              >
          ...
          <div className={styles.footerSection}>
            ...
            <ul className={styles.footerLinks}>
              <li>
                <Link
                  href="/contact?subject=Help Request"
                  className={styles.footerLink}
                >
                  Help Center
                </Link>
              ...
              <li>
                <Link
                  href="/contact?subject=Terms of Service"
                  className={styles.footerLink}
                >
                  Terms of Service
                </Link>
              ...
              <li>
                <Link
                  href="/contact?subject=Privacy Policy"
                  className={styles.footerLink}
                >
                  Privacy Policy
                </Link>
